...
const ThemeExample = () => {
  ...
  return (
    <div className="py-16 container mx-auto bg-primary px-6">
      ...
      <h1 className="text-[36px] font-bold capitalize text-center text-titleColor">
        Trusted by creators worldwide
      </h1>
      <h4 className="text-[20px] font-semibold text-center my-4 text-subTitleColor">
      ...
      <div className="grid grid-cols-12 gap-1 mt-14">
        <div className="col-span-3 text-center py-14 bg-secondary rounded-l-lg">
          ...
          <p className="text-[18px] font-medium text-textColor">
